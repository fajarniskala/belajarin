...
import 'detail_nilai_siswa_page.dart';
  ...
  Future<void> _fetchGradesRecap() async {
    try {
      final response = await http.get(
        Uri.parse(
          '${ApiConfig.baseUrl}/gurucontroller/grades-recap/${widget.guruId}',
        ),
      );
      ...
      body: _isLoading
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final double avgScore = double.parse(
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    // 🔥 2. LOGIKA NAVIGASI SEKARANG SUDAH DI PASANG DI SINI
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DetailNilaiSiswaPage(
